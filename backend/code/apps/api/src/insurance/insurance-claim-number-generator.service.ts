...
@Injectable()
export class InsuranceClaimNumberGeneratorService {
  ...
  generateNextClaimNumber(): Promise<string> {
    return this.sequenceGenerator.generateNext('insurance_claim_sequences', 'CLM');
  }
}
