...
import { RadiologyOrderCancellationSubscriber } from './radiology-order-cancellation.subscriber.js';
...
@Module({
  ...
  providers: [
    ...
    RadiologyRequisitionNumberGeneratorService,
    RadiologyOrderCancellationSubscriber,
  ],
