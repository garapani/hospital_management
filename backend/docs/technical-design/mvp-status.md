...
| `patients` | Phase 1 | Yes | Done | Full CRUD + duplicate-check endpoint. **2026-08-30 module pass:** clean — recently hardened (email/phone/gender/bloodGroup validation); only trivial observations (unbounded name lengths, loose dup-search phone) |
