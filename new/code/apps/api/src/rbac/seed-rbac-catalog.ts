...
const PERMISSION_CATALOG: PermissionSeed[] = [
  ...
  {
    name: 'billing.read',
    description: 'View invoices, payments, deposits, and returns',
  },
  {
    name: 'reporting.read',
...
const ROLE_PERMISSION_MAPPINGS: RolePermissionMapping[] = [
  ...
  { roleName: 'Super Admin', permissionName: 'billing.read' },
  { roleName: 'Hospital Admin', permissionName: 'billing.manage' },
  { roleName: 'Hospital Admin', permissionName: 'billing.read' },
